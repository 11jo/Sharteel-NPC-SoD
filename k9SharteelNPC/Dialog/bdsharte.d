...
SAY @354 /* I take it this means I'm through with you idiots? */

	IF ~~ THEN REPLY @355 /* Actually, on second thought I still require your services. */
		DO ~SetGlobal("SharTeelJoined", "GLOBAL", 1) JoinParty()~ EXIT

	IF ~~ THEN REPLY @356 /* Your respect is endearing, truly, but now that I think about it I still have need of you. */
		DO ~SetGlobal("SharTeelJoined", "GLOBAL", 1) JoinParty()~ EXIT
...
Global("KickedOut","LOCALS",1)~ THEN BEGIN bdshartp0
  SAY @354 /* I take it this means I'm through with you idiots? */
  IF ~~ THEN REPLY @358 /* Yes, it's time to part ways. */ GOTO bdshartp2
  IF ~~ THEN REPLY @359 /* No, I made a mistake. Please stay. */ GOTO bdshartp1
END

IF ~~ THEN BEGIN bdshartp1
  SAY @360 /* I'm not here to play games <CHARNAME>. */
...
IF ~HappinessLT(Myself,UNHAPPY_ANGRY_BOUNDARY)~ THEN BEGIN bdshartp3
  SAY @362 /* I've had just about enough of this crap. Our business here is done. */
  IF ~~ THEN DO ~SetGlobal("KickedOut","LOCALS",1)
...
Global("KickedOut","LOCALS",0)~ THEN BEGIN bdshartp4
  SAY @363 /* I'm tired of dealing with idiots. */
  IF ~~ THEN DO ~SetGlobal("KickedOut","LOCALS",1)
ChangeAIScript("",DEFAULT)
~ EXIT
END
